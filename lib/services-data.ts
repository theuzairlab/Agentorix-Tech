...
export const servicesData: Record<string, ServiceData> = {
  "it-services": {
    ...
    overview: "Agentorix-Tech provides end-to-end IT solutions designed for enterprise-grade performance, security, and scalability. We help businesses plan, optimize, and modernize IT infrastructure with scalable and secure technology solutions.",
    sections: [
      {
        title: "IT Consulting",
...
export const additionalServicesData: Record<string, Partial<ServiceData>> = {
  ...
  "staff-augmentation": {
    ...
    overview: "Provide professional talent fully managed by Agentorix-Tech, including developers, marketers, designers & admins.",
    sections: [
      { title: "Dedicated Remote Staff", content: "Full-time or part-time professionals managed by Agentorix-Tech" },
