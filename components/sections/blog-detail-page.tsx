...
export function BlogDetailPage({ post, relatedPosts }: BlogDetailPageProps) {
  ...
  return (
    <>
      ...
      {/* Article Content */}
      <section className="relative py-16 overflow-hidden -mt-32 pt-40 rounded-b-[150px] bg-background border-t border-border z-4">
      ...
      {relatedPosts.length > 0 && (
        <section className="relative py-24 overflow-hidden -mt-32 pt-40 rounded-b-[150px] bg-background border-t border-border z-3">
          <div className="absolute inset-0 pointer-events-none">
