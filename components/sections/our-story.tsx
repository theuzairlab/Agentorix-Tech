        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex items-center justify-center order-2 lg:order-1">
            <div className="relative w-full max-w-lg aspect-square rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Agentorix-Tech Solutions - Digital Transformation"
                fill
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-4xl sm:text-5xl font-bold mb-8 text-foreground">
              The Agentorix-Tech Story
            </h2>
            
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p className="text-lg">
                Based on our commitment to excellence, Agentorix-Tech Solutions is a leading digital transformation partner 
                for businesses worldwide and a trusted technology provider for global enterprises deploying advanced 
                digital solutions. Agentorix-Tech supports clients in two ways: accelerating digital transformation with 
            ...
            <div className="mt-8">
              <p className="text-muted-foreground">
                ...
                <a
                  href="mailto:contact@agentorix-tech.com"
                  className="text-primary hover:text-primary/80 underline transition-colors"
                >
                  contact@agentorix-tech.com
                </a>
              </p>
            </div>
          </div>
